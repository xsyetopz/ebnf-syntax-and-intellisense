...
1. Check existing [issues](https://github.com/xsyetopz/ebnf-syntax-and-intellisense/issues)
...
Open an [issue](https://github.com/xsyetopz/ebnf-syntax-and-intellisense/issues) or start a discussion on GitHub.
